...
inner join {{ref('ga_transactions_proc')}} as trans
on  tra.bigquery_name = trans.bigquery_name and tra.lookup_platform = trans.lookup_platform and trans.date = tra.date and trans.devicecategory = tra.devicecategory and trans.sourcemedium = tra.sourcemedium
